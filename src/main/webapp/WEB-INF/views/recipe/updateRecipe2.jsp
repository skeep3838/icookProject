...
<%-- 								<form:options items="${servingList}" /> --%>
							...
							<c:forTokens var="ingredName" delims="," items="${recipeBean.ingredName}">
								<tr>
									<td style="width: 50%"><input name="ingredName"
											type="text" class="form-control" value="${ingredName}" /></td>
									<td style="width: 25%"><input name="ingredQty"
											type="text" class="form-control" value="${ingredQty}" /></td>
					...
					<div id='group'>
						<table class="table" style="width: 90%" id='table1'>
							<thead>
								<tr>
									<th><input name="group1" type="text" class="form-control" /></th>
									<th></th>
									<th></th>
								</tr>
							</thead>
							<tbody id='foodtbody1'>
								<c:forTokens var="group1IngredName" delims="," items="${recipeBean.group1IngredName}">
									<tr>
										<td style="width: 50%">
											<input name="group1IngredName" type="text" class="form-control"
												value="${group1IngredName}"  /></td>
					...
					<table class="table" style="width: 90%" id='picture'>
						...
						<tbody id='picture0'>
							<c:forTokens var="step" delims="," items="${recipeBean.step}">
								<tr id='tr${i.index}'>
									<td style="width: 50%">
										<h2 id='h2Number${i.index}'>${i.index}</h2> 
										<textarea name="step" class="form-control" rows="5"><c:out value='${step}' /></textarea>
									</td>
						...
						<tfoot>
							...
							<tr>
								<td colspan="2">
									<h2>Remark</h2> 
									<form:textarea path="remark" class="form-control" rows="5" />
								</td>
							</tr>
						</tfoot>
					</table>
