package com.icook._00_init.util;
...
public class GlobalService {
	...
	public static final String SYSTEM_NAME = "愛庫克食譜社群分享平台";
	public static final int IMAGE_FILENAME_LENGTH = 20;
	public static final String JNDI_DB_NAME = "java:comp/env/jdbc/icook";
	public static final String KEY = "icookproject"; // 16, 24, 32
